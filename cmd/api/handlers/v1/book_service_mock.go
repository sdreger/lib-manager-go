...
func (_m *MockBookService) GetBookByID(ctx context.Context, bookID int64) (book.Book, error) {
...
func (_c *MockBookService_GetBookByID_Call) Return(_a0 book.Book, _a1 error) *MockBookService_GetBookByID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBookService_GetBookByID_Call) RunAndReturn(run func(context.Context, int64) (book.Book, error)) *MockBookService_GetBookByID_Call {
	_c.Call.Return(run)
	return _c
}

// GetBooks provides a mock function with given fields: ctx, pageRequest, sort, filter
func (_m *MockBookService) GetBooks(ctx context.Context, pageRequest paging.PageRequest, sort paging.Sort, filter book.Filter) (paging.Page[book.LookupItem], error) {
	ret := _m.Called(ctx, pageRequest, sort, filter)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, paging.PageRequest, paging.Sort, book.Filter) (paging.Page[book.LookupItem], error)); ok {
		return rf(ctx, pageRequest, sort, filter)
	}
	if rf, ok := ret.Get(0).(func(context.Context, paging.PageRequest, paging.Sort, book.Filter) paging.Page[book.LookupItem]); ok {
		r0 = rf(ctx, pageRequest, sort, filter)
	} else {
		r0 = ret.Get(0).(paging.Page[book.LookupItem])
	}

	if rf, ok := ret.Get(1).(func(context.Context, paging.PageRequest, paging.Sort, book.Filter) error); ok {
		r1 = rf(ctx, pageRequest, sort, filter)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockBookService_GetBooks_Call) Return(_a0 paging.Page[book.LookupItem], _a1 error) *MockBookService_GetBooks_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBookService_GetBooks_Call) RunAndReturn(run func(context.Context, paging.PageRequest, paging.Sort, book.Filter) (paging.Page[book.LookupItem], error)) *MockBookService_GetBooks_Call {
	_c.Call.Return(run)
	return _c
}
